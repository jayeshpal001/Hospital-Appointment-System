...
import { 
  FaUser, FaEnvelope, FaPhoneAlt, FaEdit, FaSignOutAlt, 
  FaMapMarkerAlt, FaGlobe, FaBirthdayCake, FaVenusMars, 
  FaTint, FaNotesMedical, FaAllergies 
} from "react-icons/fa";
            ...
            <motion.div variants={itemVariants} className="lg:col-span-1 space-y-6">
                 ...
                 <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl p-6 hover:border-white/20 transition-all group">
                    ...
                    <div className="space-y-4">
                        ...
                        {/* Address */}
                        <div className="pt-1">
                            <span className="text-gray-500 text-xs flex items-center gap-1 mb-2"><FaMapMarkerAlt /> Home Address</span>
            ...
            <motion.div variants={itemVariants} className="lg:col-span-2 space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div className="md:col-span-1 bg-linear-to-br from-red-500/10 to-pink-600/10 border border-red-500/20 rounded-3xl p-6 flex flex-col items-center justify-center text-center hover:border-red-500/40 transition-all relative overflow-hidden group">
                        ...
                        <h3 className="text-gray-400 text-sm font-medium z-10">Blood Group</h3>
                        ...
                        <div className="bg-black/20 rounded-2xl p-5 border border-white/5 min-h-30">
                            {medicalHistory ? (
                                ...
                                <p className="text-gray-500 italic flex items-center gap-2">
                                    <FaNotesMedical /> No existing medical conditions reported.
                                </p>
                            )}
                        </div>
                    </div>
                ...
                <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl p-8 flex items-center justify-between">
                    <div>
                        <h3 className="text-lg font-bold text-white mb-1">Upcoming Appointments</h3>
                        <p className="text-gray-400 text-sm">You have no scheduled appointments.</p>
                    </div>
                    <button onClick={()=>navigate("/findDoctors")} className="px-6 py-2.5 rounded-xl bg-linear-to-r from-green-500 to-teal-600 text-white font-bold shadow-lg hover:scale-105 transition-transform text-sm">
                        Book Appointment
                    </button>
                </div>
